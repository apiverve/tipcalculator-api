...
{
    class TipCalculatorExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/tipcalculator";

        /// <summary>
        /// Make a GET request to the Tip Calculator API
        /// </summary>
        static async Task<JsonDocument> CallTipCalculatorAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;amount&quot;] &#x3D; 100, [&quot;percentage&quot;] &#x3D; 18, [&quot;people&quot;] &#x3D; 4, [&quot;currency&quot;] &#x3D; &quot;USD&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Tip Calculator API...\n");

            var result = await CallTipCalculatorAPI();
