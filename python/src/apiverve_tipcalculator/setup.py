...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/tipcalculator',
        'Source': 'https://github.com/apiverve/tipcalculator-api',
        'Bug Tracker': 'https://github.com/apiverve/tipcalculator-api/issues'
    },
    classifiers=[
