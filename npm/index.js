...
class tipcalculatorWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/tipcalculator');
        }
        ...
        this.validationRules = {"amount":{"type":"number","required":true,"min":0},"percentage":{"type":"number","required":false,"min":0,"max":100,"default":15},"people":{"type":"integer","required":false,"min":1,"default":1},"currency":{"type":"string","required":false,"default":"USD"}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/tipcalculator`);
        }
    }
...
module.exports = tipcalculatorWrapper;
