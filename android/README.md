...
```gradle
dependencies {
    implementation 'com.github.apiverve:tipcalculator-api:1.1.14'
}
```
...
```java
import com.apiverve.tipcalculator.TipCalculatorAPIClient;
import com.apiverve.tipcalculator.APIResponse;
import com.apiverve.tipcalculator.APIException;

// Initialize the client
TipCalculatorAPIClient client = new TipCalculatorAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("amount", 100);
    parameters.put("percentage", 15);
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/tipcalculator](https://docs.apiverve.com/ref/tipcalculator)
...
- **Documentation:** [https://docs.apiverve.com/ref/tipcalculator](https://docs.apiverve.com/ref/tipcalculator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/tipcalculator-api/issues)
