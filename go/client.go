// Package tipcalculator provides a Go client for the Tip Calculator API.
//
// For more information, visit: https://apiverve.com/marketplace/tipcalculator?utm_source=go&utm_medium=readme
...
const (
	baseURL        = "https://api.apiverve.com/v1/tipcalculator"
	defaultTimeout = 30 * time.Second
)

// Client is the Tip Calculator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Tip Calculator API client.
...
// Execute makes a request to the Tip Calculator API with typed parameters.
//
...
//   - amount (required): number - The bill amount before tip [min: 0]
//   - percentage: number - Tip percentage [min: 0, max: 100]
//   - people: integer - Number of people to split the bill [min: 1]
