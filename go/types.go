...
// Request contains the parameters for the Tip Calculator API.
//
// Parameters:
...
type Request struct {
	...
	Percentage float64 `json:"percentage,omitempty"` // Optional
	People int `json:"people,omitempty"` // Optional
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		...
		"percentage": {Type: "number", Required: false, Min: float64Ptr(0), Max: float64Ptr(100)},
		"people": {Type: "integer", Required: false, Min: float64Ptr(1)},
...
// ResponseData contains the data returned by the Tip Calculator API.
type ResponseData struct {
	...
	SplitBetween int `json:"split_between"`
	PerPerson PerPersonData `json:"per_person"`
	CommonTipAmounts []CommonTipAmountsItem `json:"common_tip_amounts"`
}

// PerPersonData represents the per_person object.
type PerPersonData struct {
	BillAmount int `json:"bill_amount"`
	TipAmount float64 `json:"tip_amount"`
	TotalAmount float64 `json:"total_amount"`
}

// CommonTipAmountsItem represents an item in the CommonTipAmounts array.
type CommonTipAmountsItem struct {
